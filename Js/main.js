...
async function GetData() {
    $(document).ready(async function () {
        ...
        res = res.meals
        DisplayMeals(res)
        $(".meals .container .row .DMeal").click(function () {
...
async function getCategories() {
    ...
    $(".meals .container .row .Categ").click(function () {
...
${temp}
    ...
    `
    $(".meals").html(temp)
    $(".meals .container .row .DcategM").click(function () {
        let id = $(this).attr("idmeal")
        GetInstruction(id);
    })
}
...
async function GetAreaList() {
    $(document).ready(async function () {
        ...
        res = res.meals
        displayArea(res)
        $(".meals .container .row .Area").click(function () {
...
async function getIngrediant() {
    $(document).ready(async function () {
        ...
        $(".meals .container .row .Ingrediant").click(function () {
...
${temp}
    ...
    `
    $(".meals2").html(temp)
    $(".meals2 .container .row .SearchNam").click(function () {
        let id = $(this).attr("idmeal")
        $(".Search-container").addClass("d-none")
        GetInstruction(id);
    })
...
${temp}
    ...
    `
    $(".meals2").html(temp)
    $(".meals2 .container .row .SearchLett").click(function () {
        let id = $(this).attr("idmeal")
        $(".Search-container").addClass("d-none")
        GetInstruction(id);
    })
